...
//   s("sd:1").beat("<4 12>",16),
//  s("hh:4!16")
// ).djf(slider(0.618)).orbit(7)
//    // .rib(0,1/2)
//   ._scope().gain(1))

// $riser:s("pulse!16").dec(0.05).fm(time/2).fmh(time/2).orbit(12).gain(slider(0.937))
...
//   .lpenv("2")
// .pan(sine.slow(2)).gain(slider(0.61))
